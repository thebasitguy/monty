...
void node_push(stack_t **head, unsigned int number);
void stack_pall(stack_t **head, unsigned int number);
void top_pint(stack_t **head, unsigned int number);
int execute(char *content, stack_t **head, unsigned int counter, FILE *file);
void free_stack(stack_t *head);
void stack_pop(stack_t **head, unsigned int counter);
void top_swap(stack_t **head, unsigned int counter);
void top_add(stack_t **head, unsigned int counter);
void stack_nop(stack_t **head, unsigned int counter);
void top_sub(stack_t **head, unsigned int counter);
void top_div(stack_t **head, unsigned int counter);
void top_mul(stack_t **head, unsigned int counter);
void top_mod(stack_t **head, unsigned int counter);
void top_char(stack_t **head, unsigned int counter);
